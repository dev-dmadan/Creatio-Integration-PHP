...
class CreatioIntegration {
     ...
     * @param {array} data
     * @param {boolean} useWrappedBodyStyle default true
     * @return {object} result
     *              result.success {boolean}
     *              result.message {string}
     *              result.response {object}
     */
    public function rest($method, $endpoint, $data = null, $useWrappedBodyStyle = true) {
        $result = (Object)array(
            'success' => false,
            'message' => '',
            'status_code' => 0,
    ...
    private function getRestRequest($method, $endpoint, $data) {
        ...
        $result->success = ($this->curl->error || $this->curl->isHttpError()) ? false : true;
